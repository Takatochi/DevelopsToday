...
func (c CatRepository) Create(ctx context.Context, cat *models.Cat) error {
	//TODO implement me
	panic("implement me")
}

func (c CatRepository) FindAll(ctx context.Context) ([]models.Cat, error) {
	//TODO implement me
	panic("implement me")
}

func (c CatRepository) FindByID(ctx context.Context, id uint) (*models.Cat, error) {
	//TODO implement me
	panic("implement me")
}

func (c CatRepository) UpdateSalary(ctx context.Context, id uint, salary float64) {
	//TODO implement me
	panic("implement me")
}

func (c CatRepository) Delete(ctx context.Context, id uint) error {
	//TODO implement me
	panic("implement me")
}
